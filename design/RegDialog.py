...
class Ui_RegDialog(QDialog):
    ...
    def setupUi(self):
        ...
        self.PasswordFirst.setEchoMode(QtWidgets.QLineEdit.Password)
        ...
        self.PasswordSecond.setEchoMode(QtWidgets.QLineEdit.Password)
    ...
    def retranslateUi(self, RegDialog):
        ...
        self.label_3.setText(
            _translate("RegDialog", "<html><head/><body><p align=\"center\">Еще раз пароль</p></body></html>"))
